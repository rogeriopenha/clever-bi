...
_CHART_PREVIEWS = {
    "kpi": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><text x="32" y="20" text-anchor="middle" font-size="14" font-weight="bold" fill="currentColor">123</text><text x="32" y="32" text-anchor="middle" font-size="6" fill="currentColor" opacity="0.6">KPI</text><line x1="10" y1="38" x2="54" y2="38" stroke="currentColor" stroke-width="0.8" opacity="0.3"/></svg>',
    "metric": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><text x="32" y="18" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">M</text><line x1="14" y1="26" x2="50" y2="26" stroke="currentColor" stroke-width="2"/><line x1="14" y1="32" x2="40" y2="32" stroke="currentColor" stroke-width="1" opacity="0.4"/></svg>',
    "bar": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><rect x="8" y="24" width="8" height="18" rx="1" fill="currentColor" opacity="0.8"/><rect x="20" y="14" width="8" height="28" rx="1" fill="currentColor" opacity="0.6"/><rect x="32" y="20" width="8" height="22" rx="1" fill="currentColor" opacity="0.7"/><rect x="44" y="10" width="8" height="32" rx="1" fill="currentColor" opacity="0.5"/></svg>',
    "line": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><polyline points="8,36 18,28 28,30 38,18 48,22 56,10" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="8" cy="36" r="2" fill="currentColor"/><circle cx="18" cy="28" r="2" fill="currentColor"/><circle cx="28" cy="30" r="2" fill="currentColor"/><circle cx="38" cy="18" r="2" fill="currentColor"/><circle cx="48" cy="22" r="2" fill="currentColor"/><circle cx="56" cy="10" r="2" fill="currentColor"/></svg>',
    "area": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><polygon points="8,36 18,26 28,30 38,18 48,22 56,10 56,38 8,38" fill="currentColor" opacity="0.2"/><polyline points="8,36 18,26 28,30 38,18 48,22 56,10" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
    "pie": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="32" cy="24" r="14" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M32,24 L32,10 A14,14 0 0,1 44,20 Z" fill="currentColor" opacity="0.8"/><path d="M32,24 L44,20 A14,14 0 0,1 40,34 Z" fill="currentColor" opacity="0.6"/><path d="M32,24 L40,34 A14,14 0 0,1 22,34 Z" fill="currentColor" opacity="0.4"/><path d="M32,24 L22,34 A14,14 0 0,1 20,14 Z" fill="currentColor" opacity="0.5"/><path d="M32,24 L20,14 A14,14 0 0,1 32,10 Z" fill="currentColor" opacity="0.7"/></svg>',
    "scatter": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="12" cy="30" r="3" fill="currentColor" opacity="0.7"/><circle cx="22" cy="18" r="4" fill="currentColor" opacity="0.5"/><circle cx="35" cy="28" r="2.5" fill="currentColor" opacity="0.8"/><circle cx="45" cy="12" r="3.5" fill="currentColor" opacity="0.6"/><circle cx="52" cy="22" r="2" fill="currentColor" opacity="0.7"/><circle cx="30" cy="38" r="3" fill="currentColor" opacity="0.4"/><circle cx="50" cy="34" r="2.5" fill="currentColor" opacity="0.5"/></svg>',
    "histogram": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><rect x="6" y="26" width="6" height="16" rx="0.5" fill="currentColor" opacity="0.5"/><rect x="14" y="18" width="6" height="24" rx="0.5" fill="currentColor" opacity="0.6"/><rect x="22" y="8" width="6" height="34" rx="0.5" fill="currentColor" opacity="0.8"/><rect x="30" y="14" width="6" height="28" rx="0.5" fill="currentColor" opacity="0.7"/><rect x="38" y="22" width="6" height="20" rx="0.5" fill="currentColor" opacity="0.5"/><rect x="46" y="10" width="6" height="32" rx="0.5" fill="currentColor" opacity="0.6"/><rect x="54" y="20" width="6" height="22" rx="0.5" fill="currentColor" opacity="0.4"/></svg>',
    "heatmap": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><rect x="6" y="6" width="10" height="10" rx="1" fill="currentColor" opacity="0.9"/><rect x="18" y="6" width="10" height="10" rx="1" fill="currentColor" opacity="0.5"/><rect x="30" y="6" width="10" height="10" rx="1" fill="currentColor" opacity="0.7"/><rect x="42" y="6" width="10" height="10" rx="1" fill="currentColor" opacity="0.3"/><rect x="6" y="18" width="10" height="10" rx="1" fill="currentColor" opacity="0.6"/><rect x="18" y="18" width="10" height="10" rx="1" fill="currentColor" opacity="0.8"/><rect x="30" y="18" width="10" height="10" rx="1" fill="currentColor" opacity="0.4"/><rect x="42" y="18" width="10" height="10" rx="1" fill="currentColor" opacity="0.9"/><rect x="6" y="30" width="10" height="10" rx="1" fill="currentColor" opacity="0.7"/><rect x="18" y="30" width="10" height="10" rx="1" fill="currentColor" opacity="0.3"/><rect x="30" y="30" width="10" height="10" rx="1" fill="currentColor" opacity="0.6"/><rect x="42" y="30" width="10" height="10" rx="1" fill="currentColor" opacity="0.5"/></svg>',
    "funnel": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><polygon points="10,8 54,8 48,20 16,20" fill="currentColor" opacity="0.8"/><polygon points="16,20 48,20 42,32 22,32" fill="currentColor" opacity="0.6"/><polygon points="22,32 42,32 36,42 28,42" fill="currentColor" opacity="0.4"/></svg>',
    "gauge": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M10,38 A20,20 0 0,1 54,38" fill="none" stroke="currentColor" stroke-width="3" opacity="0.2"/><path d="M10,38 A20,20 0 0,1 38,20" fill="none" stroke="currentColor" stroke-width="3" opacity="0.8"/><line x1="32" y1="38" x2="32" y2="10" stroke="currentColor" stroke-width="1.5"/><line x1="32" y1="38" x2="44" y2="26" stroke="currentColor" stroke-width="1.5"/><circle cx="32" cy="38" r="3" fill="currentColor"/></svg>',
    "treemap": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><rect x="4" y="4" width="28" height="20" rx="2" fill="currentColor" opacity="0.8"/><rect x="34" y="4" width="26" height="9" rx="2" fill="currentColor" opacity="0.5"/><rect x="34" y="15" width="12" height="9" rx="2" fill="currentColor" opacity="0.6"/><rect x="48" y="15" width="12" height="9" rx="2" fill="currentColor" opacity="0.4"/><rect x="4" y="26" width="18" height="18" rx="2" fill="currentColor" opacity="0.7"/><rect x="24" y="26" width="14" height="18" rx="2" fill="currentColor" opacity="0.5"/><rect x="40" y="26" width="20" height="18" rx="2" fill="currentColor" opacity="0.3"/></svg>',
    "sunburst": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="32" cy="24" r="4" fill="currentColor"/><circle cx="32" cy="24" r="8" fill="none" stroke="currentColor" stroke-width="3" opacity="0.8"/><circle cx="32" cy="24" r="14" fill="none" stroke="currentColor" stroke-width="2" opacity="0.5"/><line x1="32" y1="24" x2="24" y2="12" stroke="currentColor" stroke-width="1.5" opacity="0.6"/><line x1="32" y1="24" x2="44" y2="16" stroke="currentColor" stroke-width="1.5" opacity="0.7"/><line x1="32" y1="24" x2="38" y2="36" stroke="currentColor" stroke-width="1.5" opacity="0.5"/><line x1="32" y1="24" x2="20" y2="34" stroke="currentColor" stroke-width="1.5" opacity="0.6"/></svg>',
    "waterfall": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><rect x="6" y="20" width="8" height="18" rx="1" fill="currentColor" opacity="0.8"/><rect x="16" y="14" width="8" height="24" rx="1" fill="currentColor" opacity="0.6"/><rect x="26" y="28" width="8" height="10" rx="1" fill="currentColor" opacity="0.4"/><rect x="36" y="10" width="8" height="28" rx="1" fill="currentColor" opacity="0.7"/><rect x="46" y="24" width="8" height="14" rx="1" fill="currentColor" opacity="0.5"/><rect x="54" y="6" width="6" height="32" rx="1" fill="currentColor" opacity="0.3"/><line x1="6" y1="38" x2="60" y2="38" stroke="currentColor" stroke-width="0.8" opacity="0.3"/></svg>',
    "map": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M12,28 Q18,12 32,10 Q46,8 52,22 Q54,30 48,38 Q42,44 32,40 Q22,36 12,28Z" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.5"/><circle cx="32" cy="24" r="2.5" fill="currentColor"/><circle cx="24" cy="18" r="1.5" fill="currentColor" opacity="0.6"/><circle cx="42" cy="16" r="2" fill="currentColor" opacity="0.5"/><circle cx="38" cy="32" r="1.5" fill="currentColor" opacity="0.7"/><circle cx="20" cy="30" r="2" fill="currentColor" opacity="0.4"/></svg>',
    "map_choropleth": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M12,28 Q18,12 32,10 Q46,8 52,22 Q54,30 48,38 Q42,44 32,40 Q22,36 12,28Z" fill="currentColor" opacity="0.3"/><path d="M28,12 L32,10 L38,14 L36,20 L28,22 Z" fill="currentColor" opacity="0.7"/><path d="M38,14 L46,12 L48,18 L42,22 Z" fill="currentColor" opacity="0.5"/><path d="M20,16 L28,12 L28,22 L22,26 Z" fill="currentColor" opacity="0.6"/><path d="M28,22 L36,20 L38,28 L30,32 Z" fill="currentColor" opacity="0.4"/><path d="M16,24 L22,26 L20,34 L14,32 Z" fill="currentColor" opacity="0.5"/></svg>',
    "map_density": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="28" cy="20" r="8" fill="currentColor" opacity="0.15"/><circle cx="28" cy="20" r="5" fill="currentColor" opacity="0.25"/><circle cx="28" cy="20" r="3" fill="currentColor" opacity="0.4"/><circle cx="40" cy="30" r="6" fill="currentColor" opacity="0.15"/><circle cx="40" cy="30" r="3.5" fill="currentColor" opacity="0.3"/><circle cx="40" cy="30" r="2" fill="currentColor" opacity="0.5"/><circle cx="20" cy="32" r="4" fill="currentColor" opacity="0.2"/><circle cx="20" cy="32" r="2" fill="currentColor" opacity="0.4"/></svg>',
    "map_routes": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M10,36 L28,18 L42,30 L54,12" fill="none" stroke="currentColor" stroke-width="1.5" opacity="0.5"/><circle cx="10" cy="36" r="3" fill="currentColor"/><circle cx="28" cy="18" r="2.5" fill="currentColor" opacity="0.7"/><circle cx="42" cy="30" r="2" fill="currentColor" opacity="0.6"/><circle cx="54" cy="12" r="3" fill="currentColor" opacity="0.8"/></svg>',
    "table": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><line x1="2" y1="14" x2="62" y2="14" stroke="currentColor" stroke-width="1.5"/><line x1="20" y1="2" x2="20" y2="14" stroke="currentColor" stroke-width="0.8" opacity="0.4"/><line x1="40" y1="2" x2="40" y2="14" stroke="currentColor" stroke-width="0.8" opacity="0.4"/><line x1="20" y1="14" x2="20" y2="46" stroke="currentColor" stroke-width="0.8" opacity="0.3"/><line x1="40" y1="14" x2="40" y2="46" stroke="currentColor" stroke-width="0.8" opacity="0.3"/><rect x="4" y="16" width="14" height="6" rx="0.5" fill="currentColor" opacity="0.15"/><rect x="22" y="16" width="16" height="6" rx="0.5" fill="currentColor" opacity="0.15"/><rect x="42" y="16" width="18" height="6" rx="0.5" fill="currentColor" opacity="0.15"/><rect x="4" y="24" width="14" height="6" rx="0.5" fill="currentColor" opacity="0.08"/><rect x="22" y="24" width="16" height="6" rx="0.5" fill="currentColor" opacity="0.08"/><rect x="42" y="24" width="18" height="6" rx="0.5" fill="currentColor" opacity="0.08"/><rect x="4" y="32" width="14" height="6" rx="0.5" fill="currentColor" opacity="0.12"/><rect x="22" y="32" width="16" height="6" rx="0.5" fill="currentColor" opacity="0.12"/><rect x="42" y="32" width="18" height="6" rx="0.5" fill="currentColor" opacity="0.12"/></svg>',
    "gantt": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><line x1="2" y1="10" x2="62" y2="10" stroke="currentColor" stroke-width="0.5" opacity="0.2"/><line x1="2" y1="20" x2="62" y2="20" stroke="currentColor" stroke-width="0.5" opacity="0.2"/><line x1="2" y1="30" x2="62" y2="30" stroke="currentColor" stroke-width="0.5" opacity="0.2"/><line x1="2" y1="40" x2="62" y2="40" stroke="currentColor" stroke-width="0.5" opacity="0.2"/><line x1="20" y1="2" x2="20" y2="46" stroke="currentColor" stroke-width="0.8" opacity="0.25"/><line x1="38" y1="2" x2="38" y2="46" stroke="currentColor" stroke-width="0.8" opacity="0.25"/><rect x="8" y="4" width="26" height="5" rx="2" fill="currentColor" opacity="0.8"/><rect x="14" y="14" width="40" height="5" rx="2" fill="currentColor" opacity="0.5"/><rect x="8" y="24" width="18" height="5" rx="2" fill="currentColor" opacity="0.7"/><rect x="30" y="24" width="16" height="5" rx="2" fill="currentColor" opacity="0.3"/><rect x="22" y="34" width="32" height="5" rx="2" fill="currentColor" opacity="0.6"/></svg>',
    "donut": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="32" cy="24" r="14" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="32" cy="24" r="6" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M32,10 A14,14 0 0,1 44,20 A6,6 0 0,0 32,16 Z" fill="currentColor" opacity="0.8"/><path d="M44,20 A14,14 0 0,1 40,34 A6,6 0 0,0 38,22 Z" fill="currentColor" opacity="0.6"/><path d="M40,34 A14,14 0 0,1 22,34 A6,6 0 0,0 28,30 Z" fill="currentColor" opacity="0.4"/><path d="M22,34 A14,14 0 0,1 20,14 A6,6 0 0,0 26,26 Z" fill="currentColor" opacity="0.5"/><path d="M20,14 A14,14 0 0,1 32,10 A6,6 0 0,0 26,16 Z" fill="currentColor" opacity="0.7"/></svg>',
    "semaforo": '<svg viewBox="0 0 64 48" width="48" height="36"><rect x="2" y="2" width="60" height="44" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/><rect x="22" y="4" width="20" height="40" rx="4" fill="none" stroke="currentColor" stroke-width="1.2"/><circle cx="32" cy="14" r="5" fill="#e63946" opacity="0.8"/><circle cx="32" cy="24" r="5" fill="#f0c040" opacity="0.7"/><circle cx="32" cy="34" r="5" fill="#2ecc71" opacity="0.6"/></svg>',
}
    ...
    for cat in _CATEGORIAS:
        ...
        for idx, (tipo_key, tipo_nome) in enumerate(cat["tipos"]):
            with cols[idx]:
                ...
                svg = _CHART_PREVIEWS.get(tipo_key, "")
                icone = _CONTROL_ICONS.get(tipo_key, "")
                preview = svg if svg else icone
                btn_label = f"{preview}\n{tipo_nome}"
